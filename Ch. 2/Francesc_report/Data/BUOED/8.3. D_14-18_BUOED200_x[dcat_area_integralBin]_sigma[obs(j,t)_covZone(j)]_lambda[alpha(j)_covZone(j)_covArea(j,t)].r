...
write.csv(summary, "8.2.Buoed200_14-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Buoed200_14-18.csv")
...
plot(pred ~ area_SG_HA, ylim=c(0,4),xlim = c(0,20), type="l", main = "TORLIT", xlab = "Guarets gestionats (HA)", ylab = "Abundància")
