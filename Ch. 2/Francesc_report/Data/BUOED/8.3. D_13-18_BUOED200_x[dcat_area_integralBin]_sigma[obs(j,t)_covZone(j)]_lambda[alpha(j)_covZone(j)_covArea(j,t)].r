...
write.csv(summary, "8.2.Buoed200_13-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Buoed200_13-18.csv")
...
# SG NO EFFECT (I THINK FROM 2014 - 2018 IT WOULD HAVE AN EFFECT)
