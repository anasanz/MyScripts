...
write.csv(summary, "8.2.Mecal500_14-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Mecal500_14-18.csv")
...
# SG POSITIVE EFFECT, PERO PLOTEO EL DEL BUFFER DE 500 DE 2013 - 2018
...
plot(pred ~ area_SGpred, ylim=c(0,4), type="l", main = "TERAX buffer.200")
