...
# Run model 8.2 in MECAL dataset. BUFFER 200 SG
...
write.csv(summary, "8.2.Mecal200_13-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Mecal200_13-18.csv")
...
plot(pred ~ area_SGpred, ylim=c(0,4), type="l", main = "CALÀNDRIA", xlab = "Guarets gestionats (HA)", ylab = "Abundància")
