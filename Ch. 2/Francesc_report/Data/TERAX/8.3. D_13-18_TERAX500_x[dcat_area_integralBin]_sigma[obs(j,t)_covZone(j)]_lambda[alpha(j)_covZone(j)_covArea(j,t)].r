...
print(out) # 60000 DOESNT CONVERGE; 65000 almost (only one Rhat>1.1), so we can trust it

summary <- as.data.frame(as.matrix(out$summary))

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
write.csv(summary, "8.2.Terax500_13-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Terax500_13-18.csv")

results500 <- summary[which(summary$X %in% c("Ntotal[1]", "Ntotal[2]", "Ntotal[3]", "Ntotal[4]", "Ntotal[5]", "Ntotal[6]", "mu.lam", "sig.lam", "bzB.lam", "ba1.lam", "ba2.lam")), ]
