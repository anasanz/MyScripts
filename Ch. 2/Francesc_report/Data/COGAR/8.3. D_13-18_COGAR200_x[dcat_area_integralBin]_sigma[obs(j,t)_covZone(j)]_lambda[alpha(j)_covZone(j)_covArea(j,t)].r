...
# Run model 8.2 in COGAR dataset. BUFFER 200 SG
...
# 2. Join the observations of COGAR (for example) with all transects so that they remain with NA if the
...
write.csv(summary, "8.2.Cogar200_13-18.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results/8.2.Francesc13-18")
summary <- read.csv("8.2.Cogar200_13-18.csv")
...
plot(pred ~ area_SGpred, ylim=c(0,4), type="l", main = "", xlab = "Guarets gestionats (HA)", ylab = "Abund?ncia")
