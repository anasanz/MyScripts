...
write.csv(summary, "8.2.Alruf500.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results")
summary <- read.csv("8.2.Alruf500.csv")
...
plot(-100,ylim = c(0,200), xlim=c(0,8),
     pch = 21, ylab = "N", xlab = " ", axes = FALSE, main = "ALRUF")
...
plot(pred ~ area_SGpred, ylim=c(0,2), type="l", main = "ALRUF buffer.500")
