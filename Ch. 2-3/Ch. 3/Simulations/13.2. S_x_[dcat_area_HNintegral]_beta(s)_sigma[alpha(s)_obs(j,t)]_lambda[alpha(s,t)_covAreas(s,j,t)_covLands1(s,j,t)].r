...
cat("model{
    ...
    lambda[j,s] <- exp(alam[s,allyears[j]] + b.a1[s]*area1[j] + b.a2[s]*area2[j] + bCropdiv[s]*cdiv[j] ) 
    } }
    # Derived parameters
    ...
    file = "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covAreas(s,j,t)_covLands1(s,j,t)].txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covAreas(s,j,t)_covLands1(s,j,t)].txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out, file = "13.2_S.RData")
