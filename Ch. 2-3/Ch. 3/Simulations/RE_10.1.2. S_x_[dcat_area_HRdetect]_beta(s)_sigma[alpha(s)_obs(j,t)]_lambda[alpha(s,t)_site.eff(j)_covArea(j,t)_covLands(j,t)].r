...
# RE:10.1 (CHANGE RANDOM EFFECT IN LAMBDA, FROM SP-SITE TO ONLY SITE) + Add landscape co-variates
...
cat("model{
    ...
    file = "s_HRdetect_beta(s)_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_site(j)_covArea(j,t)_covLands(j,t)].txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HRdetect_beta(s)_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_site(j)_covArea(j,t)_covLands(j,t)].txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out, file = "RE_10.1.2_S.RData")
