...
cat("model{
    ...
    file = "s_HRdetect_beta(s)_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covArea(j,t)].txt")
...
# MCMC settings
nc <- 3 ; ni <- 70000 ; nb <- 20000 ; nt <- 10

# With jagsUI 
out <- jags(data1, inits, params, "s_HRdetect_beta(s)_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covArea(j,t)].txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out, file = "RE4_10.1_S.RData")
