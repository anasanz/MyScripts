...
# Model 14 (1 random coefficient crop div. and sp-site), and add to this an extra random coefficient (field size)
...
cat("model{
    ...
    + b.a1[s]*area1[j] + b.a2[s]*area2[j] + bCropdiv[s]*cdiv[j] + bFieldsize[s]*fsiz[j] ) 
    ...
    file = "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_sp.site(s,j)_covAreas(s,j,t)_covLands2(s,j,t)]_BPvalues.txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_sp.site(s,j)_covAreas(s,j,t)_covLands2(s,j,t)]_BPvalues.txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

setwd("D:/ANA/Results/chapter3")
save(out, file = "14.1_S.RData")
