...
# RE4_10.1.7, with calculation of BP values
...
cat("model{
    ...
    file = "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covAreas(s,j,t)]_BPvalues.txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_covAreas(s,j,t)]_BPvalues.txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out, file = "13.1_S.RData")
