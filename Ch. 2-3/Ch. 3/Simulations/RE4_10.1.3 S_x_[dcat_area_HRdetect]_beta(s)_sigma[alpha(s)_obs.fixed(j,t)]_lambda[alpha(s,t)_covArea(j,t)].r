...
# CHANGE OBSERVER FROM RANDOM TO FIXED EFFECT
...
cat("model{
    ...
    file = "s_HRdetect_beta(s)_sigma[alpha(s)_obs.fixed(j,t)]_lambda[alpha(s,t)_covArea(j,t)].txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HRdetect_beta(s)_sigma[alpha(s)_obs.fixed(j,t)]_lambda[alpha(s,t)_covArea(j,t)].txt", n.chain = nc,
            n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)

save(out, file = "RE4_10.1.3_S(obs.fixed).RData")
