...
# MODEL 14 in Community data (15 species)
...
cat("model{
    ...
    file = "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_sp.site(s,j)_covAreas(s,j,t)_covLands1(s,j,t)]_BPvalues.txt")
...
# With jagsUI 
out <- jags(data1, inits, params, "s_HNintegral_sigma[alpha(s)_obs(j,t)]_lambda[alpha(s,t)_sp.site(s,j)_covAreas(s,j,t)_covLands1(s,j,t)]_BPvalues.txt", n.chain = nc,
