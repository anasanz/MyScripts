...
n.burnin <- 30000
n.thin <- 10
model.file <- "model15.2.1.txt"

setwd("D:/PhD/Third chapter/Data/model")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="15.2.1.RData")
...
load("D:/PhD/Third chapter/Data/model/15.2.1/JagsOutFOR15.2.1a.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/15.2.1/JagsOutFOR15.2.1b.RData")
outb <- out
load("D:/PhD/Third chapter/Data/model/15.2.1/JagsOutFOR15.2.1c.RData")
outc <- out
class(outc)
...
for (c in 1:length(coeff)){
  ...
  setwd("D:/PhD/Third chapter/Data/Results_species/15.2")
  pdf(paste("15.2.1_DATA_GOODsp_resiN", names[c], ".pdf"))
  par(mfrow = c(5,4),
      mar = c(2,1,2,0.5)) 
