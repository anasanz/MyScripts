...
setwd("D:/PhD/Third chapter/Data/model/14.2.9")
cat("model{
...
n.burnin <- 30000
n.thin <- 2
model.file <- "model14.2.9.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.9")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.9.RData")
...
load("D:/PhD/Third chapter/Data/model/14.2.9/JagsOutFOR14.2.9a.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/14.2.9/JagsOutFOR14.2.9b.RData")
outb <- out
