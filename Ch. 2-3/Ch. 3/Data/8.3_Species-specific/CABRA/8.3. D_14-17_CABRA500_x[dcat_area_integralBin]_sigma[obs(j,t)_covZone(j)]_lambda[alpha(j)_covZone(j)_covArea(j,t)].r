...
summary <- as.data.frame(as.matrix(out$summary)) # DOES NOT CONVERGE
which(summary$Rhat > 1.30)

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results")
write.csv(summary, "8.2.Cabra500_14-17.csv")

###################################################################

setwd("C:/Users/ana.sanz/OneDrive/PhD/Second chapter/Data/Results")
summary <- read.csv("8.2.Cabra500_14-17.csv")

results500 <- summary[which(summary$X %in% c("Ntotal[1]", "Ntotal[2]", "Ntotal[3]", "Ntotal[4]", "mu.lam", "sig.lam", "bzB.lam", "ba1.lam", "ba2.lam")), ]

# RESULTS BUT IT DOESNT CONVERGE (MULAM AND SIGLAM)
# AES NEGATIVE EFFECT
# SG NONE EFFECT
