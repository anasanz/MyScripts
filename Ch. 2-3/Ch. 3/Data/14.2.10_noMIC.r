...
setwd("D:/PhD/Third chapter/Data/model/14.2.10_noMIC")
cat("model{
...
params <- c( "mu_l", "sig_l", "sig_spsite",
             "b.a1", "mu_a1.com", "sig_a1.com", "sig_a1.year", "mu_a1.sp", "b.a2", "mu_a2", "sig_a2", "b.a3", "mu_a3", "sig_a3",
...
n.burnin <- 30000
n.thin <- 10
model.file <- "model14.2.10_noMIC.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.10_noMIC")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.10_noMIC.RData")

# With jagsUI 
out <- jags(data, inits, params, model.file = "model14.2.10_noMIC.txt", n.chain,
...
load("D:/PhD/Third chapter/Data/model/14.2.10_noMIC/JagsOutFOR14.2.10_noMICa.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/14.2.10_noMIC/JagsOutFOR14.2.10_noMICb.RData")
outb <- out
load("D:/PhD/Third chapter/Data/model/14.2.10_noMIC/JagsOutFOR14.2.10_noMICc.RData")
outc <- out
class(outc)
...
for (c in 1:length(coeff)){
  ...
  setwd("D:/PhD/Third chapter/Data/Results_species/14.2/14.2.10")
  pdf(paste("14.2.10_", names[c], ".pdf"))
  par(mfrow = c(5,4),
      mar = c(2,1,2,0.5)) 
...
# 2. ---- Year effect in the effect of SG

df <- as.data.frame(round(out$mean$b.a1, 3))
colnames(df) <- yrs
rownames(df) <- sp

setwd("D:/PhD/Third chapter/Data/Results_species/14.2/14.2.10")
write.csv(df, file = "year_random.csv")
