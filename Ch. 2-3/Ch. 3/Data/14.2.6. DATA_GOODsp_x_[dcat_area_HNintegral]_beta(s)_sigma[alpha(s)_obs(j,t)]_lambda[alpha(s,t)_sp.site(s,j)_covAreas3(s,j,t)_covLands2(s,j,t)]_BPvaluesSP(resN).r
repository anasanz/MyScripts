...
setwd("D:/PhD/Third chapter/Data/model/14.2.6")
cat("model{
...
n.burnin <- 30000
n.thin <- 10
model.file <- "model14.2.6.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.6")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.6.RData")

# With jagsUI 
out <- jags(data, inits, params, model.file = "model14.2.6.txt", n.chain,
...
load("D:/PhD/Third chapter/Data/model/14.2.6/JagsOutFOR14.2.6a.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/14.2.6/JagsOutFOR14.2.6b.RData")
outb <- out
load("D:/PhD/Third chapter/Data/model/14.2.6/JagsOutFOR14.2.6c.RData")
outc <- out
class(outc)
