...
n.burnin <- 100000
n.thin <- 10
model.file <- "model15.1.5.txt"

setwd("D:/PhD/Third chapter/Data/model")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="15.1.5.RData")

# With jagsUI 
out <- jags(data, inits, params, model.file = "model15.1.5.txt", n.chain,
...
load("D:/PhD/Third chapter/Data/model/15.1.1KK/JagsOutFOR15.1.1KKa.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/15.1.1KK/JagsOutFOR15.1.1KKb.RData")
outb <- out
load("D:/PhD/Third chapter/Data/model/15.1.1KK/JagsOutFOR15.1.1KKc.RData")
outc <- out
class(outc)
...
for (c in 1:length(coeff)){
  ...
  setwd("D:/PhD/Third chapter/Data/Results_species/15.1/15.1.1KK")
  pdf(paste("15.1.1KK_", names[c], ".pdf"))
  par(mfrow = c(5,4),
      mar = c(2,1,2,0.5)) 
