...
# MODEL 14.2 in Community data (37 species). Calculate species specific BPvalues
...
setwd("D:/PhD/Third chapter/Data")
aes <- read.csv("AES_15_19_FIX.csv")
sg <- read.csv("SG_15_19_FIX.csv")
green <- read.csv("GREEN_15_19_FIX.csv")
...
setwd("D:/PhD/Third chapter/Data/model/14.2.8_f")
cat("model{
...
n.burnin <- 50000
n.thin <- 10
model.file <- "model14.2.8_f.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.8_f")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.8_f.RData")

# With jagsUI 
out <- jags(data, inits, params, model.file = "model14.2.8_f.txt", n.chain,
