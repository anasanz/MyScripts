...
setwd("D:/PhD/Third chapter/Data/model/14.2.11")
cat("model{
...
setwd("D:/PhD/Third chapter/Data/model/14.2.11")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.11.RData")
