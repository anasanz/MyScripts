...
d <- d[-which(d$Species %in% c("GACRI", "GATHE", "PADOM", "STSSP", "MECAL", "MICAL")), ]
sort(unique(d$Species))
...
setwd("D:/PhD/Third chapter/Data/model/14.2.9_noMEC_noMIC")
cat("model{
    ...
    file = "model14.2.9_noMEC_noMIC.txt")
...
n.burnin <- 30000
n.thin <- 2
model.file <- "model14.2.9_noMEC_noMIC.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.9_noMEC_noMIC")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.9_noMEC_noMIC.RData")
...
load("D:/PhD/Third chapter/Data/model/14.2.9_noMEC_noMIC/JagsOutFOR14.2.9_noMEC_noMICa.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/14.2.9_noMEC_noMIC/JagsOutFOR14.2.9_noMEC_noMICab.RData")
outb <- out
...
for (c in 1:length(coeff)){
  ...
  setwd("D:/PhD/Third chapter/Data/Results_species/14.2/14.2.6")
  pdf(paste("14.2.6_", names[c], ".pdf"))
  par(mfrow = c(5,4),
      mar = c(2,1,2,0.5)) 
