...
setwd("D:/PhD/Third chapter/Data/model/14.2.2")
cat("model{
...
# With jagsUI 
out <- jags(data1, inits, params, "model14.2.2.txt", n.chain = nc,
...
n.burnin <- 30000
n.thin <- 10
model.file <- "model14.2.2.txt"

setwd("D:/PhD/Third chapter/Data/model/14.2.2")
save(data, Nst, inits, params, n.chain, n.thin, n.iter, n.burnin, model.file, file="14.2.2.RData")
...
load("D:/PhD/Third chapter/Data/model/14.2.2/JagsOutFOR14.2.2a.RData")
outa <- out
load("D:/PhD/Third chapter/Data/model/14.2.2/JagsOutFOR14.2.2b.RData")
outb <- out
load("D:/PhD/Third chapter/Data/model/14.2.2/JagsOutFOR14.2.2c.RData")
outc <- out
class(outc)
...
for (c in 1:length(coeff)){
  ...
  setwd("D:/PhD/Third chapter/Data/Results_species/14.2/14.2.2_DATA_GOODsp_resiN")
  pdf(paste("14.2.2_DATA_GOODsp_resiN", names[c], ".pdf"))
  par(mfrow = c(5,4),
      mar = c(2,1,2,0.5)) 
