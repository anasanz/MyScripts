...
sp.df <- data.frame(sp = sp, bCropdiv = rownames(out$summary)[grep("bCropdiv", rownames(out$summary))],
                    bFieldsize = rownames(out$summary)[grep("bFieldsize", rownames(out$summary))])
