...
sp.df.probpos <- data.frame(sp = sp, b.a1 = NA, b.a2 = NA, b.a3 = NA, bCropdiv= NA, bFieldsize = NA)
...
sp.df.probpos <- left_join(sp.df.probpos, leg)

nrow(sp.df.probpos[which(sp.df.probpos$b.a1 > 70), ])
