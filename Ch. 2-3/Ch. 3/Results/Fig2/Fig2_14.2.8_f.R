...
sp.df <- data.frame(sp = sp, b.a1 = rownames(out$summary)[grep("b.a1", rownames(out$summary))],
                    b.a2 = rownames(out$summary)[grep("b.a2", rownames(out$summary))],
                    b.a3 = rownames(out$summary)[grep("b.a3", rownames(out$summary))])
