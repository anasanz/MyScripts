...
dat <- read.csv("Data_DS_FIXED_10_19.csv", sep = ";")
...
pa <- readOGR("D:/PhD/Otros/Ganga", "PA") 
...
#write.csv(dat2,"DataDS_ready_para_Ganga_hq.csv") 

##################################################

# Calculate areas habitat quality AF
pa <- readOGR("D:/PhD/Otros/Ganga", "HQ_AF")
