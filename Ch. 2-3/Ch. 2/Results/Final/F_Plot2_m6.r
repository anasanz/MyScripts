...
#### The 8 first figures (the 4 with significant differences runned before wont be included here) ####

# Species
setwd("S:/PhD/Second chapter/Data")
leg <- read.csv("leg_species.csv", sep = ";")

s_good <- leg$codiEspecie[-which(leg$codiEspecie %in% c("MICAL", "COPAL", "MEAPI", "TERAX"))]
s_good <- as.character(s_good)
s_good_title <- leg$English[-which(leg$English %in% c("Corn bunting","Common wood pigeon","European bee-eater","Little bustard"))] 
...
#### The next 8 figures (9:16) (the 4 with significant differences runned before wont be included here) ####
...
#### The las 2 figures (17:18) (the 4 with significant differences runned before wont be included here) ####
...
#Plot last plot with function plot.trim.hds.overall_yo2 (that contains x-axes)
