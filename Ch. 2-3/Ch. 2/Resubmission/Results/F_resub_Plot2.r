...
# FATIN, SESER, HIRUS, CABRA, GATHE, SYMEL, CACHL, COPAL, UPEPO, PADOM, CAINA, SYCAN, ALARV
# BEFORE: COPAL, MEAPI, MICAL, TERAX
...
#s_good <- c("HIRUS", "CABRA", "CACHL", "CAINA", "SYCAN", "ALARV", "COPAL")
s_good <- c("FATIN", "SESER", "HIRUS", "CABRA", "GATHE", "SYMEL", "CACHL", "COPAL", "UPEPO", 
            "PADOM", "CAINA", "SYCAN", "ALARV")

#s_good_title <- c("Hirundo rustica", "Calandrella brachydactyla", "Carduelis chloris", "Carduelis cannabina", 
...
leg_select <- leg[-which(leg$species %in% c("FATIN", "SESER", "HIRUS", "CABRA", "GATHE", "SYMEL", "CACHL", "COPAL", "UPEPO", 
                                            "PADOM", "CAINA", "SYCAN", "ALARV", # This ones because are already plotted
                                            "GACRI", "STSSP", "MICAL", "TERAX", "MEAPI", "MECAL")), ] # This ones because of bad bp values

s_good <- leg_select$species

s_good <- as.character(s_good)
