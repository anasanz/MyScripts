...
# Compare methods using the HDS model 4 (temperature) and the se as a measure of significance of model 3 (TRIM)
...
for (xxx in 1:length(s_good)){
  ...
  setwd("S:/PhD/Second chapter/Data/Results/Plots/3autoreg_simple")
  ...
  # ---- MODEL 2 ---- ONLY FOR SIGNIFICANCE -> To compare with the significance given by the ci
  ...
  text(2011,1.5, significance_est_waldM2, col = col_est) # significance for the wald test of m2 in the left
