...
# Export GIS layer with coordinates to check errors only
writeOGR(os_spatial, "D:/Oso/Datos/GIS/Seguiment_GIS_layer", "Seguiment_Ossos_Pirineus_1996_2020_coordinates_final", driver = "ESRI Shapefile")
