...
# Random locations
temp <- setwd("D:/PhD/Fourth chapter/Results/RSF_Ana/Analisis 1/random_loc/Revision")
temp <- list.files(pattern = "*.csv")
data <- lapply(temp, read.csv, sep = ",")

##REV: I only simulated one kind of random loc for the revision
...
#for(xxx in 1:length(temp)){ 
  ...
  setwd("D:/PhD/Fourth chapter/Results/RSF_Ana/Analisis 1/data_matrix/Revision")
