...
write.csv(RSF.pval.mean, file = "RSF.pval.pre.othersec.b.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.pre.othersec.b.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.pre.othersec.b.csv")
write.csv(AIC.mean, file = "AIC.pre.othersec.b.csv")
