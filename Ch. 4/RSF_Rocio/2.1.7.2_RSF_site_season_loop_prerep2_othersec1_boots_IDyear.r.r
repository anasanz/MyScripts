...
write.csv(RSF.pval.mean, file = "RSF.pval.prerep.othersec.b.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.prerep.othersec.b.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.prerep.othersec.b.csv")
write.csv(AIC.mean, file = "AIC.prerep.othersec.b.csv")