...
write.csv(RSF.pval.mean, file = "RSF.pval.pre.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.pre.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.pre.csv")
write.csv(AIC.mean, file = "AIC.pre.csv")
