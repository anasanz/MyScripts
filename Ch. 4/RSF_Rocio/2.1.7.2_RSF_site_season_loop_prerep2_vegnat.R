...
write.csv(RSF.pval.mean, file = "RSF.pval.prerep.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.prerep.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.prerep.csv")
write.csv(AIC.mean, file = "AIC.prerep.csv")
