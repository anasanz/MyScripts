...
#                   PERIODO REP (6 DE JUNIO HASTA FIN DE AGOSTO)
#                              ROCIO TARJUELO
#-----------------------------------------------------------------------------------------
...
# Seleccionar sólo los datos para el periodo rep
datos.use.rspf <- subset(datos, periodo%in%"Rep" & STATUS == 1)
datos.avai.rspf <- subset(datos, periodo%in%"Rep" & STATUS == 0)
