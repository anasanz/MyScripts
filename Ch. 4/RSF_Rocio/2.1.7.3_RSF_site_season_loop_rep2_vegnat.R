...
write.csv(RSF.pval.mean, file = "RSF.pval.rep.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.rep.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.rep.csv")
write.csv(AIC.mean, file = "AIC.rep.csv")
