...
write.csv(RSF.pval.mean, file = "RSF.pval.pre.othersec2punt.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.pre.othersec2punt.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.pre.othersec2punt.csv")
write.csv(AIC.mean, file = "AIC.pre.othersec2punt.csv")
