...
match.use.avai2 <- data.frame(match.use.avai)
...
write.csv(RSF.pval.mean, file = "RSF.pval.pre.forest.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.pre.forest.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.pre.forest.csv")
write.csv(AIC.mean, file = "AIC.pre.forest.csv")
