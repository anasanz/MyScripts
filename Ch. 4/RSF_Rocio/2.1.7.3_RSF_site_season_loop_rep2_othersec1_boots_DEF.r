...
write.csv(RSF.pval.mean, file = "RSF.pval.rep.othersec.b.csv")
write.csv(RSF.SE.mean, file = "RSF.SE.rep.othersec.b.csv")
write.csv(RSF.Est.mean, file = "RSF.Est.rep.othersec.b.csv")
write.csv(AIC.mean, file = "AIC.rep.othersec.b.csv")
